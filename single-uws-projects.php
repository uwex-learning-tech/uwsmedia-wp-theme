...
?>
    ...
    <div class="container">
        ...
        <main class="row" role="main">
            ...
            <!-- section -->
            <section class="col-12 col-sm-12 col-md-10 offset-md-1">
