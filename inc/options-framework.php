...
function optionsframework_menu_settings() {
	...
	$menu = array(
		'page_title' => __( 'UWEX-Media Theme Options', 'optionsframework'),
		'menu_title' => __('UWEX-Media Settings', 'optionsframework'),
		'capability' => 'edit_theme_options',
		'menu_slug' => 'uwex-media-options',
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
			'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => __( 'UWEX Media Settings', 'options_framework_theme' ),
			'href' => admin_url( 'themes.php?page=uwex-media-options' )
		));
}
