( function( $, root, undefined ) {
	...
	$( function() {
		...
		***********************************************************************/
		...
		/***********************************************************************
		 KEEP TEACHING FUNCTIONS
		***********************************************************************/
		
		if ( jQuery( 'body' ).hasClass( 'keep-teaching' ) ) {
    		...
    		$(window).scroll( function() {
        		...
        		if ( $(window).scrollTop() > navBarPos ) {
            		...
            		bodyContent.addClass( 'topPadding-fix' );
        		} else {
            		navBar.removeClass( 'fixed-top' );
            		bodyContent.removeClass( 'topPadding-fix' );
        		}
    		...
    		$('.nav-link').on( 'click', function(e) {
        		...
        		if ( toggler.hasClass('collapsed') === false ) {
                    
                    $('.collapse').collapse( 'hide' );
            		$('#navbarSupportedContent').one('hidden.bs.collapse', function () {
